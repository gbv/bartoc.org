...
BARTOC is configured with a list of trusted users: if the user is trusted, an <a class="cc-button cc-button-primary cc-button-sm" href="/edit">add</a> button is shown in the menu and an <a class="cc-button cc-button-primary cc-button-sm">edit</a> button is shown next to each vocabulary title.
