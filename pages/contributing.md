...
BARTOC content is curated by an [international group of editors and collaborators](/contact). Please contact one of your choice to contribute missing terminologies or to supply corrections!
...
BARTOC is configured with a list of trusted users: if the user is trusted, an <a class="cc-button cc-button-primary cc-button-sm" href="/edit">add</a> button is shown in the menu and an <a class="cc-button cc-button-primary cc-button-sm">edit</a> button is shown next to each terminology title.

Adding and editing terminologies is possible with a web form. Its fields are documented in the form. When in doubt, feel free to ask so we can improve documentation!
